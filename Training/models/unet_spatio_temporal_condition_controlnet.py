    ...
    def forward(
        ...
        for downsample_block in self.down_blocks:
            ...
            for down_block_res_sample, down_block_additional_residual in zip(
                ...
                down_block_additional_residual = down_block_additional_residual.to(
                    device=down_block_res_sample.device, dtype=down_block_res_sample.dtype)
        ...
        sample = sample + mid_block_additional_residual.to(device=sample.device, dtype=sample.dtype)
